...
public class SpaceMenuImpl implements SpaceMenu {
    ...
    /**
     * The service that supports database operations for Spaces.
     */
     ...
     * 
     * @param spaceService The service that performs the create, update and delete
     *                     database
     *                     interactions.
     */
