...
import org.csc540.model.Citation;
import org.csc540.model.Permit;
import org.csc540.model.Vehicle;
import org.csc540.model.Zone;
import org.csc540.service.*;
...
public class CitationsMenuImpl implements CitationsMenu{
     ...
     * If the citation does exist it will allow the user to edit its fields and persist the updated model in the database.
     */
    ...
    */
    ...
    /**deleteCitationByNumberOption prompts the user for input of a citation number and calls the citation service in order to delete
     * that citation.
     */
    ...
    /**payCitationOption prompts the user for input of a citation number and calls the citation service in order to update
    ...
    /**appealCitationOption prompts the user for input of a citation number and calls the citation service in order to update
