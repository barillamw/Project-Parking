...
public class VehicleServiceImpl implements VehicleService {
     ...
     * ---------------------------------------------------------------------------
     * SQL Statement: "UPDATE Vehicles SET model = ?, color = ?, manufacturer = ?,
     ...
     * success of execution
     * ---------------------------------------------------------------------------
     * SQL Statement: "INSERT INTO Vehicles (carLicenseNumber, model, color,
